...
class QuizOnboardingPage extends StatelessWidget {
  const QuizOnboardingPage({super.key});
                ...
                Column(
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text(
                        "Challenge yourself with AI-powered quizzes and track your improvement daily.",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 15,
